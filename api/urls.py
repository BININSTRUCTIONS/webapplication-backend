...
urlpatterns = [
    ...
    path("admin/product/saas-product/plans/update", views.update_product_plan_information),
    path("admin/product/saas-product/plans/add", views.set_plan_for_saas_product),
    path("admin/product/saas-product/plans/delete", views.delete_plan_for_saas_product),
    ...
    path("admin/product/saas-product/api-info/get", views.get_api_info_for_plan),
