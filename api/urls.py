...
urlpatterns = [
    ...
    path("product/saas-product/get", views.get_saas_products),
    path("product/saas-product/plans/get", views.get_plan_for_saas_product),
    path("product/saas-product/plans/activate", views.activate_plan),
    path("product/saas-product/plans/activated/get", views.get_activated_plans),
