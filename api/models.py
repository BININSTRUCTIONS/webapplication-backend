...
from ProductApp.models import SubscriptionPlan, CompanyProduct
...
class Customer(models.Model):
    ...
    password_reset_code = models.IntegerField(null=True, blank=True)
    subscription_plans = models.ManyToManyField(SubscriptionPlan, through="CustomersHavePlans")


class CustomersHavePlans(models.Model):
    id = models.AutoField(primary_key=True)
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE)
    plans = models.ForeignKey(SubscriptionPlan, on_delete=models.SET_NULL, null=True, blank=True)
    product = models.ForeignKey(CompanyProduct, on_delete=models.SET_NULL, null=True, blank=True)
    date = models.DateTimeField()
...
class APIKey(models.Model):
    ...
    customers_have_plans = models.ForeignKey(CustomersHavePlans, on_delete=models.CASCADE)
...
class API(models.Model):
    ...
    product = models.OneToOneField(CompanyProduct, on_delete=models.CASCADE)
